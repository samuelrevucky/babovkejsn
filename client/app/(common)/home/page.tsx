    ...
    <main className="flex min-h-screen flex-col items-center">
      <div className="relative flex-col items-top justify-center white">
        ...
        <div className="flex items-top justify-center">
            <p className={`${bebas.className} text-black font-thin text-4xl p-5`}>
              Naložené domáce koláče k vám domov</p>
        </div>
        <div className="flex mb-4 justify-center">
          <Link href="/order">
            <button className={`${bebas.className}  bg-gray-500 text-white items-center py-2 px-4 text-2xl`}>Objednať</button>
          </Link>
        </div>
      </div>
      ...
      <div className=" grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        <div className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-á0`}>
